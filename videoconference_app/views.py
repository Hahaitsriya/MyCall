...
def get_response(message):
    # Simple example: map user messages to responses
    responses = {
        'hello': 'Hi there!',
        'how are you': 'I am doing fine, thank you!',
        'how to start':'Fill up the form and start call, share with your friend',
        'bye': 'Goodbye!'
        # Add more responses as needed
    }
    
    # Default response if message not recognized
    return responses.get(message.lower(), 'I did not understand that.')
